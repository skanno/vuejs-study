...
let url = 'https://vue3-study-5295f-default-rtdb.asia-southeast1.firebasedatabase.app/person.json?orderBy=%22age%22';
  ...
  setup(props) {
    ...
    const getData = () => {
      ...
      if (data.find !== '') {
        ...
        axios.get(url + '&startAt=' + range[0] + '&endAt=' + range[1]).then((result) => {
